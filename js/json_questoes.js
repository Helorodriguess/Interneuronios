const questoes = [
  {
    questao: "Questão 1",
    comando:
      "(Amabis & Martho / 2006) Como se denomina a alteração brusca na carga elétrica das superfícies interna e externa da membrana plasmática, causada por um estímulo de natureza e de intensidade adequados?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
    ...
    explicacao:
      "Resposta: c) potencial de ação. Explicação: Quando um neurônio é estimulado, a permeabilidade de sua membrana aos íons de sódio (Na+) e potássio (K+) muda, o que faz que sua diferença de potencial também mude, passando a ser de +40mV, essa inversão de potencial é chamada de potencial de ação. Esse processo é chamado de despolarização da membrana.",
  },

  {
    questao: "Questão 2",
    comando:
      "(Amabis & Martho / 2006) Qual é o nome do espaço entre a terminação de um axônio e a membrana de uma célula vizinha, através do qual o impulso nervoso é transmitido por meio de mediadores químicos?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
    ...
    explicacao:
      "Resposta: e) sinapse nervosa. Explicação: Depois de passar pelo axônio, o impulso nervoso passa para outra célula, que é chamada de pós sináptica e pode ser outro neurônio ou uma célula muscular. A região entre as extremidades dessas células, por onde ocorre a transmissão, é chamada de sinapse nervosa.",
  },

  {
    questao: "Questão 3",
    comando:
      "(Amabis & Martho / 2006) Como é chamada a propagação de uma alteração de cargas elétricas ao longo da membrana plasmática de um neurônio?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
...

  {
    ...
    explicacao:
      "Resposta: d) potencial de repouso. Explicação: Para que um impulso nervoso ocorra, um neurônio que está em potencial de repouso, ou seja, que não foi estimulado, tem sua superfície da membrana interna mais eletricamente negativa com relação ao exterior. Assim, o potencial elétrico nada mais é que uma diferença de potencial entre as faces da membrana, que costuma ser de -70mV.",
  },

  {
    questao: "Questão 5",
    comando:
      "(Amabis & Martho / 2006) Qual o nome da substância liberada pela extremidade de um axônio e que pode estimular uma célula nervosa ou uma célula muscular?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
...

  {
    ...
    explicacao:
      "Resposta: f) Sistema nervoso central. Explicação: O sistema nervoso central, responsável por interpretar informações captadas por órgãos sensoriais e elaborar respostas, é formado pelo encéfalo e medula espinhal.",
  },

  {
    questao: "Questão 9",
    comando:
      "(Amabis & Martho / 2006) Qual o nome da região especializada do encéfalo, localizada na parte posterior do crânio, que coordena as ações musculares e o equilíbrio corporal?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
...

  {
    ...
    explicacao:
      "Resposta: g) Sistema nervoso periférico. Explicação: O sistema nervoso periférico é formado por nervos e gânglios nervosos. Os nervos são estruturas constituídas por neurofibras que têm origem no encéfalo e na medula espinal e atingem diversas partes do corpo. Já os gânglios nervosos são dilatações presentes nos nervos que contém corpos celulares, de onde partem fibras.",
  },

  {
    questao: "Questão 11",
    comando:
      "(Amabis & Martho / 2006) Como se denomina um conjunto de neurofibras que parte do encéfalo e da medula e atinge certas regiões do corpo?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
    ...
    explicacao:
      "Resposta: e) Nervo. Explicação: Os nervos são estruturas constituídas por neurofibras que têm origem no encéfalo e na medula espinal e atingem diversas partes do corpo.",
  },

  {
    questao: "Questão 12",
    comando:
      "(Amabis & Martho / 2006) Qual o nome da pequena dilatação formada por corpos de neurônios presentes em certos nervos?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
    ...
    explicacao:
      "Resposta: c) Gânglio nervoso. Explicação: Os gânglios nervosos são dilatações presentes nos nervos que contém corpos celulares, de onde partem fibras nervosas.",
  },
  {
    questao: "Questão 13",
    comando:
      "(Amabis & Martho / 2006) Como se denomina um feixe de prolongamentos nervosos que conecta o encéfalo a uma ou mais regiões do corpo?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
    ...
    explicacao:
      "Resposta: d) Nervo craniano. Explicação: Os nervos cranianos conectam o encéfalo a órgãos dos sentidos e a músculos.",
  },
  {
    questao: "Questão 14",
    comando:
      "(Amabis & Martho / 2006) Que nome recebe um feixe de prolongamentos nervosos que leva informações do corpo ao sistema nervoso central?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
    ...
    explicacao:
      "Resposta: a) Nervo sensitivo. Explicação:  Os nervos podem ser classificados de acordo com a função desempenhada como: sensitivos, motores e mistos. Os nervos sensitivos, ou aferentes, são aqueles que levam os impulsos das células para o sistema nervoso central.",
  },
  {
    questao: "Questão 15",
    comando:
      "(Amabis & Martho / 2006) Como se denomina um feixe de prolongamentos nervosos que conduz impulsos nervosos do sistema nervoso central para o corpo, e vice-versa?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
  ...
  },
  {
    ...
    explicacao:
      "Resposta: b) Nervo motor. Explicação: Os nervos podem ser classificados de acordo com a função desempenhada como: sensitivos, motores e mistos. Os nervos motores, ou eferentes, são os responsáveis por enviar os impulsos do sistema nervoso central para os músculos.",
  },
  {
    questao: "Questão 17",
    comando:
      "(Amabis & Martho / 2006) Qual é o nome de um feixe de prolongamentos nervosos que conecta a medula espinal a uma ou mais regiões do corpo?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
    ...
    explicacao:
      "Resposta: e) Nervo raquidiano. Explicação: Os nervos raquidianos ou nervos espinais são os que se conectam, por meio dos espaços entre as vértebras, à medula espinal e atuam ligando esta estrutura as células sensoriais e aos músculos",
  },
  {
    questao: "Questão 18",
    comando:
      "(Amabis & Martho / 2006) Como se denomina uma das divisões do sistema nervoso autônomo cujos gânglios localizam-se perto ou mesmo dentro do órgão-alvo?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
  ...
  },
  {
    ...
    explicacao:
      "Resposta: a) Resposta reflexa. Explicação: As respostas rápidas produzidas pela medula espinal, sem que passem pelo encéfalo para serem formuladas, são chamadas de Respostas reflexas medulares ou Arco reflexos. Nesse tipo de resposta um neurônio sensitivo leva o impulso até a medula espinal, o estímulo passa pelo neurônio associativo, que faz a retransmissão para o encéfalo e para o neurônio motor. O neurônio motor coordena a ação reflexa, e o envio do estímulo ao encéfalo permite a tomada de consciência do ocorrido.",
  },
  {
    questao: "Questão 20",
    comando:
      "(Amabis & Martho / 2006) Que parte do sistema nervoso periférico regula as atividades internas do organismo independentemente da vontade?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
  ...
  },
  {
    ...
    explicacao:
      "Resposta: e) SNPA simpático. Explicação: O SNPA (sistema nervoso periférico autônomo) possui uma divisão, o SNPA simpático e SNPA parassimpático. O SNPA simpático é formado pelos nervos raquidianos que saem das regiões lombares e torácicas da medula espinal; os gânglios nervosos deste se situam nas proximidades da medula.",
  },
  {
    questao: "Questão 22",
    comando:
      "(Amabis & Martho / 2006) Que parte do sistema nervoso regula a atividade dos músculos estriados esqueléticos e cuja ação está sob o controle da vontade?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
    ...
    explicacao:
      "Resposta: c) Sistema nervoso periférico voluntário. Explicação: Realizamos diversas atividades cotidianamente e estas podem ser realizadas consciente e inconscientemente. Podemos dizer então que há duas divisões do sistema nervoso periférico, uma que acontece voluntariamente e outra que acontece de maneira natural ou involuntária. O SNP voluntário, ou somático, é responsável por coordenar as atividades voluntárias. O SNP somático é caracterizado por enviar estímulos recebidos do ambiente interno e externo para o sistema nervoso central e em seguida levar a resposta dada pelo SNC para os músculos estriados.",
  },
  {
    questao: "Questão 23",
    comando:
      "(Amabis & Martho / 2006) Qual das alternativas indica corretamente os componentes do sistema nervoso central (SNC) e do sistema nervoso periférico (SNP)?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
        alternativa:
          "Encéfalo (SNC); Gânglios nervoso (SNC); Medula espinal (SNC); Nervos (SNP);",
        classificacao: "errada",
      },
      {
        letra: "b",
        alternativa:
          "Encéfalo (SNC); Gânglios nervoso (SNP); Medula espinal (SNC); Nervos (SNC);",
        classificacao: "errada",
      },
      {
        letra: "c",
        alternativa:
          "Encéfalo (SNC); Gânglios nervoso (SNP); Medula espinal (SNC); Nervos (SNP);",
        classificacao: "correta",
      },
      {
        letra: "d",
        alternativa:
          "Encéfalo (SNP); Gânglios nervoso (SNC); Medula espinal (SNP); Nervos (SNC);",
        classificacao: "errada",
      },
    ],
    explicacao:
      "Resposta: c) Encéfalo (SNC); Gânglios nervoso (SNP); Medula espinal (SNC); Nervos (SNP);. Explicação: O sistema nervoso central é formado pelo encéfalo e medula espinhal. Já o sistema nervoso periférico se dá pelos nervos, fios brancos e finos formados pela união de neurofibras do encéfalo e medula espinhal que se ramificam por todo o corpo, e gânglios nervosos, que consistem em dilatações de alguns nervos onde há os corpos celulares provenientes das neurofibras dos nervos.",
  },
  {
    questao: "Questão 24",
    comando:
      "(Amabis & Martho / 2006) Quando uma pessoa se assusta, o ritmo cardíaco acelera-se, a pressão sanguínea eleva-se e a concentração de açúcar no sangue aumenta, entre outras coisas. Essas reações são desencadeadas diretamente pelo:",
    imagem: "",
    alternativas: [
      {
        letra: "a",
  ...
  },
  {
    ...
    explicacao:
      "Resposta: a) Cérebro. xplicação: O cérebro é formado a partir do telencéfalo e diencéfalo. O telencéfalo é a parte mais desenvolvida presente no encéfalo e a que ocupa maior parte da caixa encefálica. Esta superfície é marcada por sulcos e depressões (ou seja, possui diversos relevos e não é plana), os denominados giros cerebrais ou circunvolução cerebral; ainda sobre a superfície, esta possui um sulco (ou fenda) que divide o cérebro em dois hemisférios, onde a conexão deles é realizada pele corpo caloso (que por sua vez utiliza mais de 200 mil fibras nervosas para atuar nesta função).",
  },
  {
    questao: "Questão 26",
    comando:
      "(Amabis & Martho / 2006) Qual é a parte do encéfalo responsável pela interpretação dos estímulos sensoriais e pela elaboração de planos de ação?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
    ...
    explicacao:
      "Resposta: a) Cérebro. Explicação: As neurofibras nervosas dos sistemas SNPA simpático e parassimpático orientam os mesmos órgãos, entretanto, enquanto o SNPA simpático incentiva comportamentos que motivam energia, como a aceleração dos batimentos cardíacos; outro fato é que na maioria das vezes os neurotransmissores liberados pelos neurônios pós-ganglionares são: noradrenalina, adrenalina e acetilcolina. O SNPA parassimpático age com estimulando fontes relaxantes, como a redução do ritmo cardíaco; e o neurotransmissor que pode ser liberado pelo neurônios pós-ganglionares deste é sempre a acetilcolina.",
  },
  {
    questao: "Questão 27",
    comando:
      "(Amabis & Martho / 2006) Que porção do encéfalo é a principal responsável pela coordenação dos movimentos das diversas partes do corpo e pela manutenção do equilíbrio corporal?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
  ...
  },
  {
    questao: "Questão 28",
    comando:
      "(Amabis & Martho / 2006) Qual é a porção do encéfalo responsável pela homeostase corporal e pela integração dos sistemas nervoso e endócrino?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
  ...
  },
  {
    ...
    alternativas: [
      ...
      },
      {
        letra: "c",
        alternativa:
          "Perda da sensibilidade e paralisia muscular nas regiões inervadas.",
        classificacao: "errada",
      },
      {
        letra: "d",
    ...
    explicacao:
      "Resposta: a) Perda da sensibilidade das regiões enervadas. Explicação: O cerebelo é responsável por receber informações provindas do encéfalo e da medula espinal, que podem ser auditivas, visuais e a respeito das articulações e dos músculos. Assim, ele é responsável por ajudar a coordenar movimentos e a postura corporal. Essa estrutura está localizada entre a parte posterior do cérebro e a ponte, e conectado ao tálamo, ao tronco encefálico e a medula espinal por fibras nervosas.",
  },
  {
    questao: "Questão 30",
    comando:
      "(Amabis & Martho / 2006) Como um estímulo captado pelas células sensoriais chega à medula espinal?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
  ...
  },
  {
    ...
    explicacao:
      "Resposta: b) Sempre pela raiz ventral de um nervo raquidiano. Explicação: Entre as vértebras existem espaços pelos quais os nervos ligam-se à medula espinal, e em cada espaço há um par de nervos espinais a essa por dois conjuntos de fibras nervosas, as raízes. Um conjunto parte da região dorsal da medula e o outro da região ventral. A raiz ventral é formada por neurônios motores, responsáveis por conduzir impulsos nervosos do sistema nervoso central aos músculos.",
  },
  {
    questao: "Questão 32",
    comando:
      "(Amabis & Martho / 2006 - adaptada) Assinale a alternativa que caracteriza, com a terminologia adequada e precisa, os componentes 1, 2, 3 e 6, apontados no esquema abaixo.",
    imagem: "img/ques32.jpg",
    alternativas: [
      {
        letra: "a",
        alternativa:
          "1 - Gânglio da raiz dorsal de um nervo espinal; 2 - raiz dorsal de um nervo espinal; 3 - raiz ventral de um nervo espinal; 6 - gânglio simpático de via nervosa autônoma. ",
        classificacao: "correta",
      },
      {
        letra: "b",
        alternativa:
          "1 - Gânglio da raiz dorsal de um nervo espinal; 2 - raiz dorsal de um nervo espinal; 3 - raiz ventral de um nervo espinal; 6 - gânglio simpático de via nervosa somática. ",
        classificacao: "errada",
      },
      {
        letra: "c",
        alternativa:
          "1 - Gânglio da raiz ventral de um nervo espinal; 2 - raiz dorsal de um nervo espinal; 3 - raiz ventral de um nervo espinal; 6 - gânglio simpático de via nervosa somática. ",
        classificacao: "errada",
      },
      {
        letra: "d",
        alternativa:
          "1 - Gânglio da raiz ventral de um nervo espinal; 2 - raiz ventral de um nervo espinal; 3 - raiz dorsal de um nervo espinal; 6 - gânglio simpático de via nervosa autônoma.",
        classificacao: "errada",
      },
    ],
    explicacao:
      "Resposta: a) 1 - Gânglio da raiz dorsal de um nervo espinal; 2 - raiz dorsal de um nervo espinal; 3 - raiz ventral de um nervo espinal; 6 - gânglio simpático de via nervosa autônoma.",
  },
  {
    questao: "Questão 33",
    comando:
      "(Amabis & Martho / 2006 - adaptada) O nervo de número 7, mostrado na figura abaixo/acima, é motor e inervará alguma parte do corpo. Que tipo de parte esse nervo deverá inervar, a julgar pelas informações da figura?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
    ...
    explicacao:
      "Resposta: b) Órgão visceral ou glândula. Explicação: O SNPA (sistema nervoso periférico autônomo) possui uma divisão, o SNPA simpático e SNPA parassimpático. O SNPA simpático é formado pelos nervos raquidianos que saem das regiões lombares e torácicas da medula espinal; os gânglios nervosos deste se situam nas proximidades da medula. E o SNPA parassimpático que se dá a partir dos nervos cranianos (que saem do encéfalo) e dos raquidianos (que saem da medula espinal); os gânglios nervosos desse sistema ficam perto ou dentro do órgão inervado (que possui muitos nervos). Assim, como o nervo de número 7 possui um gânglio próximo à medula, deve inervar um órgão visceral ou glândula, já que pertence à via autônoma simpática.",
  },
  {
    questao: "Questão 34",
    comando:
      "(Amabis & Martho / 2006 - adaptada) Admitindo que o neurônio 4 seja motor somático, qual a diferença, em termos de via nervosa e órgão que inerva, quando comparado a uma via a que pertence o neurônio 8?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
        alternativa:
          "O neurônio 4 pertence à via nervosa somática (inerva músculos esqueléticos), enquanto o neurônio 8 faz parte da via nervosa autônoma (inerva vísceras ou glândulas).",
        classificacao: "correta",
      },
      {
        letra: "b",
        alternativa:
          "O neurônio 4 pertence à via nervosa somática (inerva vísceras ou glândulas), enquanto o neurônio 8 faz parte da via nervosa autônoma (inerva músculos esqueléticos).",
        classificacao: "errada",
      },
      {
        letra: "c",
        alternativa:
          "O neurônio 4 pertence à via nervosa autônoma (inerva vísceras ou glândulas), enquanto o neurônio 8 faz parte da via nervosa somática (inerva músculos esqueléticos).",
        classificacao: "errada",
      },
      {
        letra: "d",
        alternativa:
          "O neurônio 4 pertence à via nervosa autônoma (inerva músculos esqueléticos), enquanto o neurônio 8 faz parte da via nervosa somática (inerva vísceras ou glândulas).",
        classificacao: "errada",
      },
    ],
    explicacao:
      "Resposta: a) O neurônio 4 pertence à via nervosa somática (inerva músculos esqueléticos), enquanto o neurônio 8 faz parte da via nervosa autônoma (inerva vísceras ou glândulas). Explicação: O SNP somático envia estímulos recebidos para o sistema nervoso central e em seguida leva a resposta dada pelo SNC para os músculos estriados. Os nervos motores do SNP somático possuem os corpos celulares dos neurônios dentro do sistema nervoso central e as extremidades se encontram nos músculos que serão controlados; enquanto nos nervos sensoriais os corpos celulares ficam nos gânglios próximos à medula e as fibras enviam impulsos até a medula ou até o encéfalo. O SNP autônomo, ou SNP visceral, regula a parte interna do corpo e controla os sistemas nele presentes. Esse sistema possui dois tipos de neurônios, o neurônio pré-ganglionar, que está presente dentro do sistema nervoso central de onde seu axônio sai e vai até um gânglio onde se situa o corpo celular do outro, o neurônio pós-ganglionar (número 7).",
  },
  {
    questao: "Questão 35",
    comando:
      "(Amabis & Martho / 2006 - adaptada) Por que as raízes ventrais de um nervo diferem das raízes dorsais?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
        alternativa:
          "As raízes dorsais são responsáveis por receber estímulos dos órgãos do sentido e as raízes ventrais recebem estímulos dos músculos corporais.",
        classificacao: "errada",
      },
      {
        letra: "b",
        alternativa:
          "As raízes ventrais estão ligadas unicamente ao encéfalo e as raízes dorsais estão ligadas à medula, ambas são formadas por fibras nervosas mistas.",
        classificacao: "errada",
      },
      {
        letra: "c",
        alternativa:
          "A raiz dorsal é formada por neurônios sensitivos e a raiz ventral é formada por neurônios motores.",
        classificacao: "correta",
      },
    ],
    explicacao:
      "Resposta: c) A raiz dorsal é formada por neurônios sensitivos e a raiz ventral é formada por neurônios motores. Explicação: A raiz dorsal é formada por neurônios sensitivos responsáveis por conduzir impulsos nervosos de órgãos sensitivos até o sistema nervoso central. A raiz ventral é formada por neurônios motores, responsáveis por conduzir impulsos nervosos do sistema nervoso central aos músculos.",
  },
  {
    questao: "Questão 36",
    comando:
      "(UFSM - RS) Pode-se dizer que o acúmulo de mercúrio afeta a sobrevivência e o funcionamento dos ______. Tanto a transmissão do impulso nervoso, que ocorre sempre dos ______ para os _____, quanto a liberação de neurotransmissores são prejudicadas. Assinale a alternativa que completa corretamente as lacunas:",
    imagem: "",
    alternativas: [
      {
        letra: "a",
    ...
    explicacao:
      "Resposta: c) Neurônios - dendritos - axônios. Explicação: O mercúrio pode afetar as células nervosas (neurônios). Essas células são responsáveis pela transmissão do impulso nervoso, que ocorre em sentido único: dos detritos segue para o corpo celular e então para os axônios.",
  },
  {
    questao: "Questão 37",
    comando:
      "(PUC - RJ) Um organismo pluricelular necessita transportar, de forma eficiente e rápida, informações para todas as células do seu corpo. Quanto mais eficiente for esta sinalização de acontecimentos, melhor a resposta do indivíduo e melhor deve ser sua adaptação ao meio. Quais os sistemas envolvidos diretamente nesse processo de sinalização?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
  ...
  },
  {
    ...
    explicacao:
      "Resposta: a) V - F - V - V - V. Explicação: Com exceção da afirmativa II, as outras estão corretas, isso porque a ponte e o cerebelo controlam o equilíbrio corporal, enquanto o bulbo raquidiano é responsável por controlar as funções vitais, como os batimentos cardíacos e a respiração.",
  },
  {
    questao: "Questão 39",
    comando:
      "(PUC - SP) Nas alternativas a seguir são mostrados os três itens: Parte do sistema nervoso estimulada; Substância liberada; Efeito sobre o ritmo cardíaco. Qual das alternativas apresenta corretamente o que se dá com uma pessoa em situação de perigo?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
    ...
    explicacao:
      "Resposta: c) I - Simpático; II - adrenalina; III - aumento. Explicação: O SNPA simpático incentiva comportamentos que motivam energia, como a aceleração dos batimentos cardíacos, permitindo ao organismo responder a situações de estresse. Na maioria das vezes os neurotransmissores liberados pelos neurônios pós-ganglionares são: noradrenalina, adrenalina e acetilcolina.",
  },
  {
    questao: "Questão 40",
    comando:
      "(PUC RS - 2022) Considere as seguintes afirmações sobre o estrato mielínico: I. sua degeneração é a causa da esclerose múltipla. II. suas estruturas celulares são denominadas nódulos de Ranvier. III. as interrupções nele observadas correspondem às células de Schwann. Está/Estão correta(s) a(s) afirmativa(s):",
    imagem: "",
    alternativas: [
      {
        letra: "a",
  ...
  },
  {
    ...
    explicacao:
      "Resposta: b) dura-máter, aracnoide e pia-máter. Explicação: De fora para dentro, as membranas (meninges) são: dura-máter; aracnoide e pia-máter. (Vestibulando web. Disponível em: https://www.vestibulandoweb.com.br/biologia/questoes-sistema-nervoso-neuronio/ Acesso em: 04 jul. 2023).",
  },
  {
    questao: "Questão 49",
    comando:
      "(Pism - UFJF/2018) O consumo abusivo de álcool e o uso de maconha, cocaína e outras drogas ilícitas são considerados sérios problemas de saúde pública, já que prejudicam o funcionamento do sistema nervoso dos usuários. O consumo dessas drogas altera a transmissão do impulso nervoso, afetando a comunicação entre os neurônios em regiões específicas do cérebro. Sobre o funcionamento do tecido nervoso assinale a alternativa INCORRETA:",
    imagem: "",
    alternativas: [
      {
        letra: "a",
  ...
  },
  {
    ...
    explicacao:
      "Resposta: d) inibição da secreção do neurotransmissor. Explicação: Ao inibir a despolarização da membrana do axônio, não há o estímulo para que ocorra liberação do neurotransmissor na fenda sináptica. (Vestibulando web. Disponível em: https://www.vestibulandoweb.com.br/biologia/questoes-sistema-nervoso-neuronio/ Acesso em: 04 jul. 2023).",
  },
  {
    questao: "Questão 52",
    comando:
      " (UFOP) As várias atividades do organismo dependem do perfeito funcionamento do sistema nervoso: os neurônios levam informações da periferia para o SNC e vice-versa. Para exercerem essas atividades, os neurônios apresentam certas características, que não estão bem definidas em:",
    imagem: "",
    alternativas: [
      {
        letra: "a",
      ...
      },
      {
        letra: "b",
        alternativa:
          "O impulso nervoso sempre é conduzido do corpo celular para o axônio, para passagem de informações entre neurônios.",
        classificacao: "errada",
      },
      {
        letra: "c",
        alternativa:
          "Os mediadores químicos estão sempre armazenados no corpo celular dos neurônios.",
        classificacao: "correta",
      },
      {
        letra: "d",
        alternativa:
          "A bainha de mielina torna a condução do impulso nervoso mais rápida nos neurônios.",
        classificacao: "errada",
      },
    ],
    explicacao:
      "Resposta: c) Os mediadores químicos estão sempre armazenados no corpo celular dos neurônios. Explicação: Os mediadores químicos (neurotransmissores) ficam armazenados em vesículas localizadas nas extremidades do axônio. (Vestibulando web. Disponível em: https://www.vestibulandoweb.com.br/biologia/questoes-sistema-nervoso-neuronio/ Acesso em: 04 jul. 2023).",
  },
  {
    questao: "Questão 53",
    comando:
      "(CESMAC/2016) Nos seres humanos, o tecido nervoso constitui o principal sistema de integração corporal. Considerando a natureza do impulso nervoso, analise as afirmativas abaixo: em um neurônio em repouso, a superfície interna da membrana plasmática se encontra eletricamente mais positiva que a externa. o potencial de ação compreende a diferença dos potenciais elétricos entre as duas faces da membrana plasmática de neurônios estimulados. a despolarização, observada em neurônios estimulados, percorre a membrana sempre do axônio para os dendritos. Está(ão) correta(s):",
    imagem: "",
    alternativas: [
      {
        letra: "a",
  ...
  },
  {
    questao: "Questão 56",
    comando:
      "(FAZU-MG) a região de encontro entre os neurônios e órgãos, onde ocorre a transmissão química de impulsos elétricos, é denominada:",
    imagem: "",
    alternativas: [
      {
        letra: "a",
    ...
    explicacao:
      "Resposta: e) Sinapse. Explicação: A sinapse fica localizada entre os neurônios  estes que agem como neurotransmissores, transmitindo o impulso nervoso de um neurônio a outro.A sinapse é a responsável por fazer ligação entre as células assim levando o impulso nervoso por todo o sistema neural.",
  },
  {
    questao: "Questão 57",
    comando:
      "(UFG-GO (adaptada)) Um chimpanzé com lesão no cerebelo tem comprometida a sua capacidade de ",
    imagem: "",
    alternativas: [
      {
        letra: "a",
  ...
  },
  {
    ...
    alternativas: [
      ...
      },
      {
        letra: "d",
        alternativa:
          "no corpo celular dos neurônios, bloqueando o metabolismo.",
        classificacao: "errada",
      },
      {
        letra: "e",
    ...
    explicacao:
      "Resposta b) nas sinapses, impedindo a transmissão do impulso nervoso. Explicação: Ao agir nas sinapses, locais onde os neurônios se encontram bem próximos, os anestésicos impedem que o impulso se propague de uma célula para outra.",
  },
  {
    questao: "Questão 60",
    comando:
      "(Fuvest-SP) Qual dos seguintes comportamentos envolve maior número de órgãos do sistema nervoso?",
    imagem: "",
    alternativas: [
      {
        letra: "a",
  ...
  },
  {
    ...
    explicacao:
      "Resposta: a) Bulbo. Explicação: O bulbo é uma parte do encéfalo relacionada com a respiração, os batimentos cardíacos e a deglutição.",
  },
  {
    questao: "Questão 62",
    comando:
      "(UFSM) Pode-se dizer que o acúmulo de mercúrio afeta a sobrevivência e o funcionamento dos....... Tanto a transmissão do impulso nervoso, que ocorre sempre dos ..... para os ........... quanto a liberação de neurotransmissores é prejudicada. Indique a alternativa que completa corretamente as lacunas:",
    imagem: "",
    alternativas: [
      {
        letra: "a",
    ...
    explicacao:
      "Resposta: c) neurônios — dendritos — axônios. Explicação: O mercúrio é uma substância que causa degeneração neural. O impulso nervoso acontece sempre no sentido dendrito, corpo celular e axônio.",
  },
  {
    questao: "Questão 63",
    comando:
      " (Brasil Escola/2023) A medula espinhal é uma estrutura cilíndrica que se estende desde o forame magno até a segunda vértebra lombar. Essa estrutura está relacionada com respostas simples e rápidas a determinados estímulos, tais como retirar a mão de um objeto quente. Essas respostas são chamadas de respostas reflexas medulares. A respeito das respostas reflexas medulares, marque a alternativa correta.",
    imagem: "",
    alternativas: [
      {
        letra: "a",
        alternativa:
          "Nesse tipo de resposta, o encéfalo manda rapidamente um estímulo, sem que seja necessária a interferência da medula.",
        classificacao: "errada",
      },
      {
        letra: "b",
        alternativa:
          "A medula leva rapidamente o estímulo ao cérebro que produz uma resposta reflexa extremamente rápida.",
        classificacao: "errada",
      },
      {
        letra: "c",
        alternativa:
          "Nesse processo, não há intervenção do encéfalo, sendo a medula a responsável por gerar a resposta.",
        classificacao: "correta",
      },
      {
        letra: "d",
        alternativa:
          "Nas respostas reflexas medulares, o cérebro gera uma resposta e envia para a medula, que processa e responde ao estímulo.",
        classificacao: "errada",
      },
    ],
    explicacao:
      "Resposta: c) Nesse processo, não há intervenção do encéfalo, sendo a medula a responsável por gerar a resposta. Explicação: Nas respostas reflexas medulares, o encéfalo não interfere na resposta ao estímulo sensorial.",
  },
  {
    questao: "Questão 64",
    comando:
      " (Vunesp-SP) Imagine as seguintes situações: 1- Você vai tomar uma injeção e fica com o braço distendido, recebendo a picada da agulha sem nenhuma reação. 2- Você estava distraído e alguém picou-lhe o braço com um alfinete; a reação foi um salto. Os órgãos do sistema nervoso que controlaram a primeira e a segunda reação foram, respectivamente:",
    imagem: "",
    alternativas: [
      {
        letra: "a",
    ...
    explicacao:
      "Resposta: d) Cérebro e medula. Explicação: Ao saber que vamos tomar uma injeção, controlamos nossos impulsos, sendo assim, teremos um ato voluntário controlado pelo cérebro. Quando estamos desprevenidos, a resposta é um ato reflexo e involuntário, comandado pela medula.",
  },
];
