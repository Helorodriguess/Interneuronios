const questoes = [
    ...
    {
        questao: 'Questão 32',
        comando: '(Amabis & Martho / 2006 - adaptada (63)) Assinale a alternativa que caracteriza, com a terminologia adequada e precisa, os componentes 1, 2, 3 e 6, apontados no esquema abaixo/acima.',
        alternativas: [{
            letra: 'a',
